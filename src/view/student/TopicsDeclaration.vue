<template>
    <div id="smain11" class="bodys sdectop">
        <div class="soperation">
            ...
            <div class="btn">
                <el-button type="primary" @click="dialogFormVisible = true" :disabled="isOpen">申报<i class="el-icon-upload2 el-icon--right"></i></el-button>
            </div>
        </div>
        <div class="stable">
            <div class="tabledata">
        ...
        <el-dialog title="课题申报" :visible.sync="dialogFormVisible">
            ...
            <div slot="footer" class="dialog-footer">
                ...
                <el-button type="primary" @click="declare">申 报</el-button>
            </div>
        </el-dialog>
    </div>
</template>
...
<script>
    ...
    import {currentChangeing, declareing, findPageing, initDataing} from '../../js/student/TopicsDeclaration'
