<template>
    <div id="dmain10" class="bodys dmf">
        <div class="dopertion">
            <div class="title1">
                <span>论文终稿审批</span>&nbsp;
                <span>
...
<script>
    ...
    import {finalFindPageing, currentChangeing, agreeing, handleRefuseding, batchAgreeing, handleSelectionChangeing, refuseding, 
            handleBatchRefuseding, onSubmitimg,} from '../../js/departmentChair/DFinalExamination'
