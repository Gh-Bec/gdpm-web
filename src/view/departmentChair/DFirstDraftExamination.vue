...
<script>
    ...
    import {firstFindPageing, currentChangeing, agreeing, handleRefuseding, batchAgreeing, handleSelectionChangeing, refuseding, 
            handleBatchRefuseding, onSubmitimg,} from '../../js/departmentChair/DFirstDraftExamination'
