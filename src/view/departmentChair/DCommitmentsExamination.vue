<template>
    <div id="dmain5" class="bodys dcomopen">
        <div class="dopertion">
            <div class="title1">
                <span>任务书查看</span>
            </div>
...
<script>
    ...
    import {commitFindPageing, currentChangeing, handleSelectionChangeing, onSubmitimg, } from '../../js/departmentChair/DCommitmentsExamination'
