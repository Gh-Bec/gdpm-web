...
<script>
    ...
    import {commitFindPageing, currentChangeing, agreeing, handleRefuseding, batchAgreeing, handleSelectionChangeing, refuseding, 
            handleBatchRefuseding} from '../../js/teacher/CommitmentsExamination';
    ...
    export default {
        ...
        methods: {
            ...
            async commitFindPage() {
                var that = this;
                commitFindPageing(that);
            },
