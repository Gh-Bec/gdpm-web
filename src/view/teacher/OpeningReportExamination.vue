                ...
                <el-table :data="tableData" border style="width: 100%" max-height="520" stripe @selection-change="handleSelectionChange">
                    ...
                    <el-table-column label="操作" width="400">
                        <template slot-scope="scope">
                            ...
                            <!-- <el-button size="mini" type="success" @click="download(scope.$index, scope.row)">下载</el-button> -->
...
<script>
    import {previewing, downloading} from '../../js/global/PublicMethods';
    import {batchDownloading} from '../../js/teacher/TeacherManagement';
    import {currentChangeing, agreeing, handleRefuseding, batchAgreeing, handleSelectionChangeing, refuseding, openFindPageing, 
            handleBatchRefuseding} from '../../js/teacher/OpeningReportExamination'
