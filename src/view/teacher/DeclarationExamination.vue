<template>
    <div id="tmain4" class="bodys dere">
...
<script>
    ...
    import {currentChangeing, agreeing, handleRefuseding, batchAgreeing, handleSelectionChangeing, toIntroduceViewing, 
            refuseding, handleBatchRefuseding, declarationFindPageing} from '../../js/teacher/DeclarationExamination'
